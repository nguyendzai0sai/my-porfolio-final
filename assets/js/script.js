...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Nguyen Duong";
...
var typed = new Typed(".typing-text", {
    strings: ["E-commerce Data Analyst", "Business Intelligence Analyst"],
    loop: true,
    typeSpeed: 60,
    backSpeed: 30,
    backDelay: 1500,
...
async function fetchData(type = "skills") {
    ...
    if (type === "skills") {
        response = await fetch("skills.json" + cacheBuster);
    } else if (type === "experience") {
        response = await fetch("experience.json" + cacheBuster);
    }
...
// experience interactive modal starts
let experienceData = [];
...
// experience interactive modal ends
